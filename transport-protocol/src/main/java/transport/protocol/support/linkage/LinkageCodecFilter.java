...
public class LinkageCodecFilter extends CodecFilter{
	
	private static final Logger logger = LoggerFactory.getLogger(LinkageCodecFilter.class);
	
	private Map<String, Encoder> encoders;

	private Map<String, Decoder> decoders;
	
	public LinkageCodecFilter(Map<String, Encoder> encoders, Map<String, Decoder> decoders){
